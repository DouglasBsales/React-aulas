const ModalDeleNote = ({
  handleClickDeleteNoteModal,
  handleClickModalClosedDeleteNote,
  id,
}) => {
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-gray-800 bg-opacity-50">
      <div className="w-[400px] h-[150px] flex flex-col items-center justify-between fixed top-[200px] bg-white rounded-md">
        ...
        <div className="w-full flex justify-around items-center pb-[18px] ">
          ...
          <div>
            <button
              ...
              onClick={() => handleClickDeleteNoteModal(id)}
            >
